...
The project includes four trained deep learning models:

1. Face Shape Detection Model  
2. Gender Classification Model  
3. Hair Type Detection Model  
4. Skin Type Classification Model  
